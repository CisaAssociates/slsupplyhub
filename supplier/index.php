...
include '../partials/page-title.php'; ?> 
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p>Total Sales: ₱<?php echo number_format($analytics['metrics']['sales'], 2); ?></p>
                                        <p>Top Products:</p>
                                        <ul>
                                            <?php foreach ($analytics['metrics']['top_products'] as $product): ?>
                                                <li><?php echo htmlspecialchars($product['name']); ?> - ₱<?php echo number_format($product['sales'], 2); ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Customer Feedback</h4>
                                        <ul>
                                            <?php foreach ($feedback['feedback'] as $item): ?>
                                                <li><?php echo htmlspecialchars($item['customer_name']); ?>: <?php echo htmlspecialchars($item['feedback_comment']); ?> (Rating: <?php echo $item['feedback_rating']; ?>)</li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/users/user-2.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                            <span class="ms-2">Imelda J. Stanberry</span>
                                                        </td>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/cards/visa.png" alt="user-card" height="24" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/users/user-3.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                            <span class="ms-2">Francisca S. Lobb</span>
                                                        </td>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/cards/master.png" alt="user-card" height="24" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/users/user-1.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                            <span class="ms-2">James A. Wert</span>
                                                        </td>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/cards/amazon.png" alt="user-card" height="24" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/users/user-4.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                            <span class="ms-2">Dolores J. Pooley</span>
                                                        </td>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/cards/american-express.png" alt="user-card" height="24" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/users/user-5.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                            <span class="ms-2">Karen I. McCluskey</span>
                                                        </td>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/cards/discover.png" alt="user-card" height="24" />
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/products/product-1.png" alt="product-pic" height="36" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/products/product-2.png" alt="product-pic" height="36" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/products/product-3.png" alt="product-pic" height="36" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/products/product-4.png" alt="product-pic" height="36" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= asset_url() ?>images/products/product-5.png" alt="product-pic" height="36" />
        ...
        <!-- Plugins js-->
        <script src="<?= asset_url() ?>libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="<?= asset_url() ?>libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>

        <!-- Dashboard init js -->
        <script src="<?= asset_url() ?>js/pages/ecommerce-dashboard.init.js"></script>
